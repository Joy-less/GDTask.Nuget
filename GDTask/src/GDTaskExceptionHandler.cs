...
{
    /// <summary>
    /// Propagate <see cref="OperationCanceledException" /> to <see cref="UnobservedTaskException" /> when true. Default is
    /// false.
    /// </summary>
    ...
    /// </summary>
    /// <remarks>
    /// This event is invoked when a <see cref="GDTask" /> completes with an exception that is not observed (i.e., not awaited
    /// or handled).
    /// If no handlers are subscribed to this event, the exception details will be logged using
