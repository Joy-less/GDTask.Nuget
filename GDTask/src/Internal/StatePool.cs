...
{
    public static StateTuple<T1> Create<T1>(T1 item1) => StatePool<T1>.Create(item1);

    public static StateTuple<T1, T2> Create<T1, T2>(T1 item1, T2 item2) => StatePool<T1, T2>.Create(item1, item2);

    public static StateTuple<T1, T2, T3> Create<T1, T2, T3>(T1 item1, T2 item2, T3 item3) => StatePool<T1, T2, T3>.Create(item1, item2, item3);
}

class StateTuple<T1> : IDisposable
{
    public T1 Item1;
...
class StateTuple<T1, T2> : IDisposable
{
    public T1 Item1;
    public T2 Item2;
...
static class StatePool<T1, T2>
{
    ...
    public static StateTuple<T1, T2> Create(T1 item1, T2 item2)
    {
        ...
        return new() { Item1 = item1, Item2 = item2 };
    }
...
class StateTuple<T1, T2, T3> : IDisposable
{
    public T1 Item1;
    public T2 Item2;
    public T3 Item3;
...
static class StatePool<T1, T2, T3>
{
    ...
    public static StateTuple<T1, T2, T3> Create(T1 item1, T2 item2, T3 item3)
    {
        ...
        return new() { Item1 = item1, Item2 = item2, Item3 = item3 };
    }
