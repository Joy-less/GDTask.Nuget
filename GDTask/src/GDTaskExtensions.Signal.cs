...
{
    /// <summary>
    /// Create a new <see cref="SignalAwaiter" /> awaiter configured to complete when the instance source emits the signal
    /// specified by the signal parameter, and wrap it in a <see cref="GDTask" />.
    /// </summary>
...
public static partial class GDTaskExtensions
{
    ...
    /// </summary>
    public static async GDTask<Variant[]> AsGDTask(this SignalAwaiter signalAwaiter) => await signalAwaiter;
